...
class InstallWizard(QDialog):
    ...
    def restore_or_create(self):
        ...
        msg = _("HDM could not find an existing wallet.") + "\n\n" \
    ...
    def waiting_dialog(self, task, msg= _("HDM is generating your addresses, please wait.")):
        def target():
            task()
    ...
    def network_dialog(self):
        ...
        label = QLabel(_("HDM communicates with remote servers to get information about your transactions and addresses. The servers all fulfil the same purpose only differing in hardware. In most cases you simply want to let HDM pick one at random if you have a preference though feel free to select a server manually.") + "\n\n" \
